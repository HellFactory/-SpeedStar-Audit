...
interface SpeedInterface extends ethers.utils.Interface {
  functions: {
...
export type UpdateAdminEvent = TypedEvent<
  [string, boolean] & { admin: string; isAdmin: boolean }
>;

export class Speed extends BaseContract {
  ...
  filters: {
    ...
    "UpdateAdmin(address,bool)"(
      admin?: null,
      isAdmin?: null
    ): TypedEventFilter<[string, boolean], { admin: string; isAdmin: boolean }>;
